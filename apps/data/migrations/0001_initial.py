# Generated by Django 3.2.3 on 2021-06-02 06:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boundprofession', models.ManyToManyField(blank=True, related_name='_data_profession_boundprofession_+', to='data.Profession', verbose_name='связанные профессии')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, default='', max_length=30, verbose_name='адрес')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.ManyToManyField(blank=True, to='data.Skill', verbose_name='компетенции')),
            ],
        ),
        migrations.CreateModel(
            name='Univer',
        ...
        migrations.AddField(
            model_name='course',
            name='profession',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='data.profession', verbose_name='Компетенция'),
        ),
        migrations.AddField(
            model_name='course',
            name='profiles',
