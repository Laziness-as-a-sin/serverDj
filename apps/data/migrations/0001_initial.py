    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_experience', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='data.workexperience', verbose_name='опыт работы')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='data.city')),
                ...
                ('profession', models.ManyToManyField(blank=True, to='data.Profession')),
                ('skills', models.ManyToManyField(blank=True, to='data.Skill')),
